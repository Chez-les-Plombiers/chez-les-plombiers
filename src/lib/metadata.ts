...
export const DEFAULT_METADATA = {
  title: "Chez Les Plombiers | Lieu Événementiel Paris 1er",
  description:
    "Espace événementiel de 200m² au cœur de Paris. Fashion shows, séminaires, dîners d'exception. 39 rue des Bourdonnais, 75001.",
  openGraph: {
    title: "Chez Les Plombiers | Lieu Événementiel Paris 1er",
    description:
      "Espace événementiel de 200m² au cœur de Paris. Fashion shows, séminaires, dîners d'exception.",
    url: SITE_URL,
    siteName: SITE_NAME,
    images: [
      {
