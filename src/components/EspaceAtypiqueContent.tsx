          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <motion.a
                ...
                className="inline-flex items-center gap-3 border border-white/40 hover:border-white px-8 py-4 text-sm uppercase tracking-widest transition-all duration-300"
              >
